...
Add support for json to xml and vice versa conversion. 

cd to Book-data-converter/bin folder and try command "java com/java/fileconverter/Convert input.json xml" and vice versa. 
input.xml and input.json files are exixt in "inputfiles" folder.

And it will generate output in "outputfiles" folder as output.json and output.xml file.
